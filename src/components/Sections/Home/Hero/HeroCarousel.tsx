	...
	return (
		<div className='overflow-hidden w-full max-h-215 flex flex-col gap-4 lg:gap-10 lg:flex-row  '>
			<div className='flex lg:flex-col lg:w-full'>
				<HeroCarouselTrack imagesData={repeatCarousel1} className='animate-carousel-1' />
				<HeroCarouselTrack imagesData={repeatCarousel1} className='animate-carousel-1 aria-hidden' />
			</div>
			<div className='flex lg:flex-col  lg:w-full'>
				<HeroCarouselTrack imagesData={repeatCarousel2} className='animate-carousel-2' />
				<HeroCarouselTrack imagesData={repeatCarousel2} className='animate-carousel-2 aria-hidden' />
			</div>
		</div>
	);
}
